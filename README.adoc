...
The following https://youtu.be/rEeAML74oWo?t=67[video] shows how to download the OptaPlanner Vehicle Routing distribution and run it using the `runLocally.sh` script.
