...
public class DataSetTest {
    ...
    public void unmarshall() throws IOException {
        ...
        DataSet dataSet;
        try (InputStream inputStream = DataSetTest.class.getResourceAsStream("test-belgium.yaml")) {
            dataSet = mapper.readValue(new InputStreamReader(inputStream), DataSet.class);
        }
