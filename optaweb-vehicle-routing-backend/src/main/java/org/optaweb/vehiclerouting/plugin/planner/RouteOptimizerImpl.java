...
class RouteOptimizerImpl implements RouteOptimizer,
    ...
    @Override
    public void addLocation(LocationNew domainLocationNew,
                            DistanceMatrix distanceMatrix) {
        RoadLocation location = SolutionUtil.planningLocation(domainLocationNew);
        DistanceMap distanceMap = new DistanceMap(domainLocationNew, distanceMatrix.getRow(domainLocationNew));
    ...
    @Override
    public void removeLocation(LocationNew domainLocationNew) {
        Location location = SolutionUtil.planningLocation(domainLocationNew);
        if (!isSolving()) {
