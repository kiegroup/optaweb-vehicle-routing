...
package org.optaweb.vehiclerouting.domain.timewindowed;
...
public class TimeWindowedCustomer extends Customer {
    ...
    @CustomShadowVariable(variableListenerClass = ArrivalTimeUpdatingVariableListener.class,
            ...
            // because this shadow must be triggered after nextCustomer (but there is no need to be triggered by
            // nextCustomer)
